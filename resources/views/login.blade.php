                        ...
                        <div class="col-lg-6">
                            <div class="login-sec">
                                <ul class="sign-control">
                                    <li data-tab="tab-1" class="current"><a href="#" title="">Sign in</a>
                                    </li>
                                    <li data-tab="tab-2"><a href="#" title="">Sign up</a></li>
                                </ul>
                                <div class="sign_in_sec current" id="tab-1">
                                    <h3>Sign in</h3>
                                    <form name="loginForm" id="loginForm" method="post" action="login-user">
                                        @csrf
                                        <div class="row">
                                    ...
                                    <div class="dff-tab current" id="tab-3">
                                        <form name="registerForm" id="registerForm" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 no-pdd">
                                                    <div class="sn-field">
                                                        <input type="text" name="first_name"
                                                            id="register_firstname" placeholder="Full Name" required>
                                                        <i class="la la-user"></i>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 no-pdd">
                                                ...
                                                <div class="col-lg-12 no-pdd">
                                                    <div class="sn-field">
                                                        <input type="text" name="country" id="register_country"
                                                ...
                                                <div class="col-lg-12 no-pdd">
                                                    <div class="sn-field">
                                                        <input type="password" name="re_password"
                                                            id="register_repeatPassword" placeholder="Repeat Password"
                                                            required>
                                                        <i class="la la-lock"></i>
                                                    </div>
                                                </div>
