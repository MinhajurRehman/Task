    ...
    <div
        ...
        <div class="mx-auto max-w-7xl p-6 lg:p-8">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
                    <a href="{{ url('/login') }}"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Go to the Task</h2>
            ...
            <div class="mt-16 flex justify-center px-0 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-center text-lg text-gray-500 dark:text-gray-400 sm:ml-0 sm:text-right">
